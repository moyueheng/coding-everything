...
2. **Move to archives:**
   ...
   **For Projects:**
   - **Single file:** Move to `99_Archive/Projects/YYYY/ProjectName.md`
   - **Folder:** Move to `99_Archive/Projects/YYYY/ProjectName/`
   - Organize by year based on completion date

   **For Inbox Items:**
   - Move to `99_Archive/Inbox/YYYY/MM/filename.md`
...
**Archived [N] projects to `99_Archive/Projects/YYYY/`:**
- [[Project1]] → Archives/Projects/2026/Project1/
- [[Project2]] → Archives/Projects/2026/Project2.md

**Archived [N] inbox items to `99_Archive/Inbox/YYYY/MM/`:**
...
(They'll be moved to 99_Archive/ but wikilinks will continue to work)
